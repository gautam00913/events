                                    ...
                                    <x-tr>
                                        <x-td>
                                          <div class="flex space-x-2 items-center">
                                            <p>{{ $key +1 }}</p>
                                            <x-button type="button" :disabled="$transaction->refunded_at" :data-id="$transaction->id" :data-url="route('transactions.detail', $transaction->id)" class="validateTransaction">Valider</x-button>
                                          </div>
                                        </x-td>
