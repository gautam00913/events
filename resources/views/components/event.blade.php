<div class="{{ $event->premium ? 'bg-blue-200' : 'bg-white' }} rounded-lg shadow-md hover:shadow-2xl transition ease-linear delay-300 hover:shadow-yellow-500">
    <div class="h-full flex flex-col justify-between ">
        ...
        <div class="text-center">
            ...
            <div class="flex items-center mb-4 space-x-3 justify-center">
                <x-button class="buyTicket" :disabled="$place === 0" type="button">Prendre de ticket</x-button>
                <x-button title="Partager avec les amis" class="shareEvent" :disabled="$place === 0" type="button" :data-slug="$event->slug" :data-event="$event->title">
